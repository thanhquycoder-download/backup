...
('0191eb50-0002-7000-8000-000000000002', '6839204', 1, 'TPBank (Ngân Hàng Tiên Phong)', '10004397102', 'PHAN THANH QUY', 2000000.00, 'ThanhQuyTech6839204', 'Success', DATE_SUB(NOW(), INTERVAL 3 HOUR), DATE_SUB(NOW(), INTERVAL 3 HOUR)),
('0191eb50-0003-7000-8000-000000000003', '3185927', 1, 'TPBank (Ngân Hàng Tiên Phong)', '10004397102', 'PHAN THANH QUY', 850000.00, 'ThanhQuyTech3185927', 'Success', DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)),
('0191eb50-0004-7000-8000-000000000004', '7524918', 1, 'TPBank (Ngân Hàng Tiên Phong)', '10004397102', 'PHAN THANH QUY', 320000.00, 'ThanhQuyTech7524918', 'Success', DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)),
('0191eb50-0002-7000-8000-000000000002', '9281045', 1, 'TPBank (Ngân Hàng Tiên Phong)', '10004397102', 'PHAN THANH QUY', 500000.00, 'ThanhQuyTech9281045', 'Pending', NULL, DATE_SUB(NOW(), INTERVAL 15 MINUTE))
