    ...
    <header class="app-header">
        ...
        <div class="header-right">
            ...
            <div class="dropdown user-dropdown">
                <button type="button" class="user-profile-toggle" id="userProfileToggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false" title="<?= htmlspecialchars($currentUser['name']) ?>">
                    <img src="<?= htmlspecialchars($currentUser['avatar']) ?>" alt="Avatar" class="user-avatar-small">
                </button>
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 py-2 mt-2" style="min-width: 220px;">
                    <li class="px-3 py-2 border-bottom">
                        ...
                        <div class="text-muted small"><?= htmlspecialchars($currentUser['username']) ?></div>
                        <div class="text-primary small font-monospace mt-1">UID: #<?= htmlspecialchars($currentUser['uid']) ?></div>
                    </li>
                    <li>
                    ...
                    <?php if ($isAdmin): ?>
                    <li>
                        <button type="button" class="dropdown-item py-2 text-dark" data-bs-toggle="modal" data-bs-target="#adminPlatformModal">
